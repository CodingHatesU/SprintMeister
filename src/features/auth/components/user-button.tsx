        ...
        <DropdownMenu modal={false}>
            ...
            <DropdownMenuContent align="end" side="bottom" className="w-60" sideOffset={10}>
                <div className="flex flex-col items-center justify-center gap-2 px-2.5 py-4">
                    <Avatar className="size-10 transition border-neutral-300">
                ...
                <DottedSaperator className="mb-1"/>
                <DropdownMenuItem 
                    className="h-10 flex items-center justify-center text-amber-700 font-mediun cursor-pointer"
                    onClick={() => logout()}
                >
